...
import { Cover } from '@/components/market/cover/inde'
...
export default function Market() {
  ...
  function handleUseCoupon(id: string) {
    ...
    Alert.alert(
      'Cupom',
      'Não é possível reutilizar um cupom regatado. Deseja realmente resgatar o cupom?',
      [
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Modal style={{ flex: 1 }} visible={isCameraModalVisible}>
        ...
        <View style={{ position: 'absolute', bottom: 33, left: 32, right: 32 }}>
          <Button
